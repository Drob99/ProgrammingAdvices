...

{
     ...
     cout << "Number of words: " << String1.CountEachWordInString() << endl;

     cout << "Number of words: " << String1.CountEachWordInString("Fadi ahmed rateb omer") << endl;

     cout << "Number of words: " << clsString::CountEachWordInString("Mohammed Saqer Abu-Hadhoud") << endl;
     ...
     cout << "After inverting a : "
          << clsString::InvertCharCase('a') << endl;
     ...
     cout << "Words Count" << String3.CountEachWordInString()
          << endl;
