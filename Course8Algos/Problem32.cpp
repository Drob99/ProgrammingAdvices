...
DateLibrary::sDate IncreaseDateByOneMillenium(DateLibrary::sDate Date)
{
    Date.Year += 1000;
...
int main()
{
    ...
    printf("\n14-Adding One Millenium is: %d/%d/%d", Date.Day, Date.Month, Date.Year);
}
